        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">DayZ Setup Guide</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">DayZ Mods & Scripts</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Rust Server Config</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Server Optimization</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Bot Development</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Server Setup</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Moderation Tools</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">API Examples</a></li>
            </ul>
          </div>
